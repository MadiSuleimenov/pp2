...
leftarm = pygame.image.load("lab09/images/left_hand.png")
rightarm = pygame.image.load("lab09/images/right_hand.png")
mainclock = pygame.transform.scale(pygame.image.load("lab09/images/clock.png"), (800, 600))
